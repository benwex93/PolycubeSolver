...
from reinforcement_learning.polycubeRL import PolycubeRL
...
if __name__ == "__main__":
	...
	elif str(args.solver) == 'reinforcement':
		PolycubeRL = PolycubeRL(same_shapes)
		PolycubeRL.run(cube_open_vertices, shapes_names, transformed_shapes)